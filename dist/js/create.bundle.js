...
console.log(url, 'URL');
var btnSubmit = document.querySelector('.btn-create-send');
var inputFile = document.querySelector('#file-input');
var fileNameField = document.querySelector('#file-name');
inputFile.addEventListener('change', function (event) {
  var containerFile = document.querySelector('.container_upload_file');
...
btnSubmit.addEventListener('click', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
    var image, name, shortDesc, completDesc, reader, sendDataToAPI, _sendDataToAPI;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _sendDataToAPI = function _sendDataToAPI4() {
            _sendDataToAPI = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(imageData) {
          ...
          sendDataToAPI = function _sendDataToAPI3(_x2) {
            return _sendDataToAPI.apply(this, arguments);
          };
          event.preventDefault();
          image = document.querySelector('#file-input').files[0];
          name = document.querySelector('#characterName').value;
          shortDesc = document.querySelector('#shortDesc').value;
          completDesc = document.querySelector('#completDesc').value;
