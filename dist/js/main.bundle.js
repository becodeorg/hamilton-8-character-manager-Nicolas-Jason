...
var allCharacterContainer = document.querySelector('.container_character_list');
var getBody = document.querySelector('body');
var getOverlay = document.querySelector('#overlay');
var idCharacter;
function getAllCharacter() {
  var getAllCharacterApi = fetch('https://character-database.becode.xyz/characters');
  getAllCharacterApi.then( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(response) {
      var allCharacter, getAllBtn;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            allCharacter.forEach(function (element) {
              var imgBase64ToJs = 'data:image/png;base64,' + element.image;
              ...
              var createImgInFigure = document.createElement('img');
              createImgInFigure.setAttribute('src', imgBase64ToJs);
              createFigure.append(createImgInFigure);
              var createDivTextContent = document.createElement('div');
              ...
              var paragraphTextNode = document.createTextNode(element.shortDescription);
            ...
            getAllBtn = document.querySelectorAll('.btn');
...
function getCharacterById(idCharacter) {
  ...
  var getCharacterApi = fetch('https://character-database.becode.xyz/characters/' + idCharacter);
  getCharacterApi.then( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(response) {
      var responseCharacter, name, shortDesc, longDesc, image, cardImg, imgBase64ToJs, cardName, cardShortDesc, cardDescription;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return response.json();
          case 3:
            responseCharacter = _context2.sent;
            name = responseCharacter.name;
            shortDesc = responseCharacter.shortDescription;
            longDesc = responseCharacter.description;
            image = responseCharacter.image;
            cardImg = document.querySelector('.card-img-overlay');
            imgBase64ToJs = 'data:image/png;base64,' + image;
            cardImg.src = imgBase64ToJs;
            cardName = document.querySelector('.card-name-overlay');
            cardName.textContent = name;
            cardShortDesc = document.querySelector('.short-desc');
            cardShortDesc.textContent = shortDesc;
            cardDescription = document.querySelector('.description');
...
var articleElement = document.querySelector('#overlay article');
...
btnEdit.addEventListener('click', function (event) {
  location.replace("/page/edit_character.html?".concat(idCharacter));
});
function deleteCharacter() {
  return _deleteCharacter.apply(this, arguments);
}
function _deleteCharacter() {
  _deleteCharacter = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var response;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 4;
          return fetch('https://character-database.becode.xyz/characters/' + idCharacter, {
            method: "DELETE"
          });
        case 4:
        ...
        case 15:
          ...
          console.log("Erreur lors de la suppression !", _context3.t0);
        case 18:
        case "end":
...
var btnDelete = document.querySelector('.btn-del');
